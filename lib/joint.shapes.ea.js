...
joint.shapes.ea.Table = joint.shapes.editor.Element.extend({
    defaults: _.defaultsDeep({
        ...
        attrs: {
            ...
            '.editor-element-name-rect': { 'width':ELEMENT_WIDTH, 'stroke': '#fff', 'stroke-width': 0.5, 'fill': '#1AB0A2' },
            '.editor-element-attrs-rect': { 'width':ELEMENT_WIDTH, 'stroke': '#fff', 'stroke-width': 0.5, 'fill': '#33C9BB' },
