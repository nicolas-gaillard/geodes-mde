        ...
        buttons: {
            formSubmit: {
                ...
                action: function () {
                    ...
                    if (model instanceof cd.Class) {
                        model.trigger('cd-update');
                    }
                    else if ((model instanceof fragment.Source) || 
                        (model instanceof fragment.Target)){
                        model.trigger('fragment-update');
                    }
                }
            },
            cancel: function () {
...
joint.shapes.tm.toolElement = joint.shapes.basic.Generic.extend({
    ...
    toolMarkup: ['<g class="element-tools">',
        ...
        '<g class="element-tool-new-attr" transform="translate(50,0)"><circle fill="#FF7D4D" stroke="#fff" stroke-width="0.7" r="11"/>',
