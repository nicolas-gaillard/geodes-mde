...
joint.shapes.fragment.Target = joint.shapes.editor.Element.extend({
    ...
    defaults: _.defaultsDeep({
        ...
        attrs: {
            '.editor-element-name-rect': { 'width': ELEMENT_WIDTH, 'stroke': '#fff', 'stroke-width': 0.5, 'fill': '#F7B733' },
            '.editor-element-attrs-rect': { 'width': ELEMENT_WIDTH, 'stroke': '#fff', 'stroke-width': 0.5, 'fill': '#FFD14D' },
...
joint.shapes.fragment.Source = joint.shapes.editor.Element.extend({
    ...
    defaults: _.defaultsDeep({
        ...
        attrs: {
            '.editor-element-name-rect': { 'width': ELEMENT_WIDTH, 'stroke': '#fff', 'stroke-width': 0.5, 'fill': '#C6C3CA' },
            '.editor-element-attrs-rect': { 'width': ELEMENT_WIDTH, 'stroke': '#fff', 'stroke-width': 0.5, 'fill': '#DFDCE3' },
