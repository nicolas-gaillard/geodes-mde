...
joint.shapes.cd.Attribute = joint.shapes.basic.Generic.extend({
    ...
    setAttributeName: function(newName) {
        this.prop('name', newName);
        //this.trigger('change:name');
        this.findView(paper).update();  // Must fix it
    },

    setAttributeType: function(newType) {
    ...
    updateRectangle: function() {
        ...
        attrs['.cd-attribute-text'].text = this.getAttributeName() + ' : ' + this.getAttributeType();
    },
