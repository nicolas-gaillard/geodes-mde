...
joint.shapes.cd.Class = joint.shapes.editor.Element.extend({
    ...
    defaults: _.defaultsDeep({
        ...
        attrs: {
            ...
            '.editor-element-name-rect': { 'width':ELEMENT_WIDTH, 'stroke': '#fff', 'stroke-width': 0.5, 'fill': '#FF6434' },
            '.editor-element-attrs-rect': { 'width':ELEMENT_WIDTH, 'stroke': '#fff', 'stroke-width': 0.5, 'fill': '#FF7D4D' },
